<template>
  <div
    :class="[fullsize ? 'fullsize' : 'page']"
    :id="href"
    :style="{ 'align-items': align, 'margin-bottom': dist * 45 + 'px' }"
  >
        ...
        <table class="container" :style="{ backgroundColor: colorswitch }">
          <tr>
            ...
            <td class="forth">
              <input
                v-model="message"
                placeholder="Teste deine Eigene Headline"
              />
            </td>
    ...
    <div class="container" :style="textposit">
      ...
      <p v-if="bigheadline && !headline" class="bigheadline">
        {{ bigheadline }}
      </p>
