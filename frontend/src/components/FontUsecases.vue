<template>
  ...
  >
    <div class="textbox">
      ...
      <div
        v-if="showSubheadline"
        class="subheadline"
        @click="
          (subheadlineOpen = !subheadlineOpen),
            (headlineOpen = false),
            (fltextOpen = false)
        "
      >
    ...
    <div class="settings">
      ...
      >
        ...
        <i
          class="far"
          :class="{
            'fas fa-angle-right': !headlineOpen,
            'fas fa-angle-down': headlineOpen,
          }"
        ></i>
      </div>
      ...
      <div
        :style="!headlineOpen ? 'height: 0px' : 'height: 200px'"
      ...
      >
        ...
        <i
          class="far"
          :class="{
            'fas fa-angle-right': !subheadlineOpen,
            'fas fa-angle-down': subheadlineOpen,
          }"
        ></i>
      </div>
      ...
      <div
        :style="!subheadlineOpen ? 'height: 0px' : 'height: 200px'"
        class="subheadlineStetting setting"
      >
      ...
      >
        ...
        <i
          class="far"
          :class="{
            'fas fa-angle-right': !fltextOpen,
            'fas fa-angle-down': fltextOpen,
          }"
        ></i>
      </div>
      ...
      <div
        :style="!fltextOpen ? 'height: 0px' : 'height: 350px'"
        class="fltextSetting setting"
      >
        <textarea
          v-model="fltext"
          placeholder="Teste deinen eigenen Fließtext"
        ></textarea>
